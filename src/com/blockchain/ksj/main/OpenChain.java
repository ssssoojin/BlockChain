...
import com.blockchain.ksj.core.Transaction;
import com.blockchain.ksj.core.TransactionOutput;
import com.blockchain.ksj.core.Wallet;
...
public class OpenChain {
	...
	public static void main(String[] arg){
		...
		System.out.println("A-Private keys:"+StringUtil.getStringFromKey(walletA.privateKey));
		System.out.println("A-public keys:"+StringUtil.getStringFromKey(walletA.publicKey));
